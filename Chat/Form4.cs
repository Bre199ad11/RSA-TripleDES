...
namespace Chat
{
    public partial class Form4 : Form
    {
        public Form4()
        {
            ...
            TripleDESHash.Data_From_User1ToUser2.EventHandler = new TripleDESHash.Data_From_User1ToUser2.MyEvent(TripleDESTxtChange);
        ...
        public void TripleDESHashEncrypt(string txt)
        {
            using (TripleDES TDAlg = TripleDES.Create())
            {
                ...
                TripleDESHash.Data_From_User2ToUser1.EventHandler(output, key, vector);
            }
